...
| Epic | Name | Overall |
|------|------|---------|
| E00 | Application Bootstrapping | In Progress |
...
|---------|------|------|---------|---------|
| FT-00-BE | E00 | Backend Fundamentals | In Progress | ST-00 |
...
|-------|---------|------|---------|
| ST-00 | FT-00-BE | Provide Basic Backend API Availability | In Progress |
