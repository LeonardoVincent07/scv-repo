...
| EP-04 | Client Profile Assembly | Planned |
...
| FT-10 | EP-04 | Assemble Canonical Profile | Planned | ST-20, ST-21 |
...
|-------|---------|------|---------|
| ST-00 | FT-00-BE | Provide Basic Backend API Availability |  |
| ST-00-FRONTEND-UI-SHELL | FT-00-UI | Provide Frontend UI Shell Availability |  |
...
| ST-20 | FT-10 | Assemble base profile | Planned |
